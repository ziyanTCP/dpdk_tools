...
#ifndef AUM_COORDINATOR_INCLUDE_MIDDLEMAN_ACTORS_TCP_CONN_TCP_STREAM_H_
#define AUM_COORDINATOR_INCLUDE_MIDDLEMAN_ACTORS_TCP_CONN_TCP_STREAM_H_
#include "socket.h"
#include "tcp.h"
...
typedef struct tcp_stream
{
    ...
    rte_be32_t src_addr;			//* in network order *//*
    rte_be32_t dst_addr;			//* in network order *//*
    rte_be16_t src_port;			//* in network order *//*
    rte_be16_t dst_port;			//* in network order *//*
...
/*struct tcp_stream * CreateTCPStream(struct actor_tcp_conn * mystate, socket_map_t socket, int type,
...
#endif //AUM_COORDINATOR_INCLUDE_MIDDLEMAN_ACTORS_TCP_CONN_TCP_STREAM_H_
